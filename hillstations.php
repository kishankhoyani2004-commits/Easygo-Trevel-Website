...
<head>
<meta charset="UTF-8">
<title>Hill Stations | Easy Go</title>
...
<div class="hs-container">
    ...
    <h2>Hill Station Packages</h2>

    <div class="hs-grid">

        <!-- CARD 1 -->
        <div class="hs-card">
            <img src="images/india/manali.jpg" class="hs-img" alt="Manali">
            <h3>🌄 Manali – Himachal Pradesh</h3>
            <div class="price-tag">Starting from ₹5,499</div>
        ...
        <!-- CARD 2 -->
        <div class="hs-card">
            <img src="images/shimla_photo.jpg" class="hs-img" alt="Shimla">
            <h3>🏔️ Shimla Escape</h3>
            <div class="price-tag">Starting from ₹6,999</div>
            <div class="card-footer">
                <button class="hotel-book-btn bookBtn">Book Now</button>
            </div>
        </div>
        ...
        <!-- CARD 3 -->
        <div class="hs-card">
            <img src="images/munnar_photo.jpg" class="hs-img" alt="Munnar">
            <h3>🍃 Munnar – Kerala Hills</h3>
            <div class="price-tag">Starting from ₹7,899</div>
            <div class="card-footer">
                <button class="hotel-book-btn bookBtn">Book Now</button>
            </div>
        </div>
        ...
        <!-- CARD 4 -->
        <div class="hs-card">
            <img src="images/ooty_photo.jpg" class="hs-img" alt="Ooty">
            <h3>🌿 Ooty – Queen of Hills</h3>
            <div class="price-tag">Starting from ₹6,299</div>
            <div class="card-footer">
                <button class="hotel-book-btn bookBtn">Book Now</button>
            </div>
        </div>
        ...
        <!-- CARD 5 -->
        <div class="hs-card">
            <img src="images/darjeeling_photo.jpg" class="hs-img" alt="Darjeeling">
            <h3>❄️ Darjeeling Snow Views</h3>
            <div class="price-tag">Starting from ₹8,450</div>
            <div class="card-footer">
                <button class="hotel-book-btn bookBtn">Book Now</button>
            </div>
        </div>
        ...
        <!-- CARD 6 -->
        <div class="hs-card">
            <img src="images/gangtok_photo.jpg" class="hs-img" alt="Gangtok">
            <h3>⛰️ Gangtok – Sikkim</h3>
            <div class="price-tag">Starting from ₹9,999</div>
            <div class="card-footer">
                <button class="hotel-book-btn bookBtn">Book Now</button>
            </div>
        </div>
