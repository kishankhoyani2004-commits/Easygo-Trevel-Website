...
<head>
<meta charset="UTF-8">
<title>Cruise Packages | Easy Go</title>
...
<div class="cruise-container">
    ...
    <h2>Cruise Online Booking</h2>

    <div class="cruise-grid">

        <!-- CARD 1 -->
        <div class="cruise-card">
            <img src="images/mumbaicruise_photo.jpg" class="cruise-img" alt="Mumbai Cruise">
            <div class="card-content">
                <h3>🛳️ Mumbai Cruise Holiday</h3>
                <div class="price-tag">Starting from ₹12,999</div>
        ...
        <!-- CARD 2 -->
        <div class="cruise-card">
            <img src="images/chennaicruise_photo.jpg" class="cruise-img" alt="Chennai Cruise">
            <div class="card-content">
                <h3>⛴️ 2 Nights Chennai Cruise</h3>
                <div class="price-tag">Starting from ₹9,499</div>
                <div class="card-footer">
                    <button class="hotel-book-btn bookBtn">Book Now</button>
                </div>
            </div>
        ...
        <!-- CARD 3 -->
        <div class="cruise-card">
            <img src="images/goacruise_photo.jpg" class="cruise-img" alt="Goa Cruise">
            <div class="card-content">
                <h3>🏝️ Goa Lakshadweep Cruise Vacation</h3>
                <div class="price-tag">Starting from ₹15,799</div>
                <div class="card-footer">
                    <button class="hotel-book-btn bookBtn">Book Now</button>
                </div>
            </div>
        ...
        <!-- CARD 4 -->
        <div class="cruise-card">
            <img src="images/srilankacruise_photo.jpg" class="cruise-img" alt="Sri Lanka Cruise">
            <div class="card-content">
                <h3>🚢 Sri Lanka Cruise Package</h3>
                <div class="price-tag">Starting from ₹22,490</div>
                <div class="card-footer">
                    <button class="hotel-book-btn bookBtn">Book Now</button>
                </div>
            </div>
        ...
        <!-- CARD 5 -->
        <div class="cruise-card">
            <img src="images/andamancruise_photo.jpg" class="cruise-img" alt="Andaman Cruise">
            <div class="card-content">
                <h3>🛥️ Andaman Luxury Cruise Tour</h3>
                <div class="price-tag">Starting from ₹29,999</div>
                <div class="card-footer">
                    <button class="hotel-book-btn bookBtn">Book Now</button>
                </div>
            </div>
        ...
        <!-- CARD 6 -->
        <div class="cruise-card">
            <img src="images/dubaicruise_photo.jpg" class="cruise-img" alt="Dubai Cruise">
            <div class="card-content">
                <h3>🌊 Dubai Premium Sea Cruise</h3>
                <div class="price-tag">Starting from ₹34,200</div>
                <div class="card-footer">
                    <button class="hotel-book-btn bookBtn">Book Now</button>
                </div>
            </div>
