...
<head>
<meta charset="UTF-8">
<title>Family Trips | Easy Go</title>
...
<div class="family-container">
    ...
    <div class="family-grid">
        ...
        <div class="family-card">
            <img src="images/andaman_photo.jpg" class="family-img" alt="Andaman Family Tour">
            <h3>👨‍👩‍👧 Andaman Family Tour</h3>
            <div class="price">Rs. 18,999 /-</div>
        ...
        <!-- CARD 2 -->
        <div class="family-card">
            <img src="images/india/manali.jpg" class="family-img" alt="Manali Family Package">
            <h3>🏔️ Manali Family Package</h3>
            <div class="price">Rs. 14,499 /-</div>
            <div class="card-footer">
                <button class="hotel-book-btn bookBtn">Book Now</button>
            </div>
        </div>
        ...
        <!-- CARD 3 -->
        <div class="family-card">
            <img src="images/india/kerala.jpg" class="family-img" alt="Kerala Backwaters Family Trip">
            <h3>🌊 Kerala Backwaters Family Trip</h3>
            <div class="price">Rs. 17,299 /-</div>
            <div class="card-footer">
                <button class="hotel-book-btn bookBtn">Book Now</button>
            </div>
        </div>
        ...
        <!-- CARD 4 -->
        <div class="family-card">
            <img src="images/dubai/burj_khalifa.jpg" class="family-img" alt="Dubai Family Vacation">
            <h3>🎢 Dubai Family Vacation</h3>
            <div class="price">Rs. 42,999 /-</div>
            <div class="card-footer">
                <button class="hotel-book-btn bookBtn">Book Now</button>
            </div>
        </div>
        ...
        <!-- CARD 5 -->
        <div class="family-card">
            <img src="images/indonesia/bali_beach.jpg" class="family-img" alt="Bali Family Escape">
            <h3>🏖️ Bali Family Escape</h3>
            <div class="price">Rs. 38,499 /-</div>
            <div class="card-footer">
                <button class="hotel-book-btn bookBtn">Book Now</button>
            </div>
        </div>
        ...
        <!-- CARD 6 -->
        <div class="family-card">
            <img src="images/shimla_photo.jpg" class="family-img" alt="Shimla & Kufri Family Trip">
            <h3>🌄 Shimla & Kufri Family Trip</h3>
            <div class="price">Rs. 15,299 /-</div>
            <div class="card-footer">
                <button class="hotel-book-btn bookBtn">Book Now</button>
            </div>
        </div>
