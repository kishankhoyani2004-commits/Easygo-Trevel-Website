...
<head>
<meta charset="UTF-8">
<title>Trekking Packages | Easy Go</title>
...
<div class="trek-container">
    ...
    <div class="trek-grid">
        ...
        <!-- CARD 1 -->
        <div class="trek-card">
            <img src="images/triund-photo.jpeg" class="trek-img" alt="Triund Trek">
            <h3>🥾 Triund Trek – Dharamshala</h3>
            <div class="price-tag">Starting from ₹3,499</div>
        ...
        <!-- CARD 2 -->
        <div class="trek-card">
            <img src="images/kedarkanthtrek_photo.jpg" class="trek-img" alt="Kedarkantha Trek">
            <h3>⛰️ Kedarkantha Snow Trek</h3>
            <div class="price-tag">Starting from ₹7,999</div>
            <div class="card-footer">
                <button class="hotel-book-btn bookBtn">Book Now</button>
            </div>
        </div>
        ...
        <!-- CARD 3 -->
        <div class="trek-card">
            <img src="images/Valleyflowers_photo.jpg" class="trek-img" alt="Valley of Flowers">
            <h3>🏞️ Valley of Flowers Trek</h3>
            <div class="price-tag">Starting from ₹9,200</div>
            <div class="card-footer">
                <button class="hotel-book-btn bookBtn">Book Now</button>
            </div>
        </div>
        ...
        <!-- CARD 4 -->
        <div class="trek-card">
            <img src="images/hampta_photo.jpg" class="trek-img" alt="Hampta Pass">
            <h3>🗻 Hampta Pass Expedition</h3>
            <div class="price-tag">Starting from ₹11,499</div>
            <div class="card-footer">
                <button class="hotel-book-btn bookBtn">Book Now</button>
            </div>
        </div>
        ...
        <!-- CARD 5 -->
        <div class="trek-card">
            <img src="images/Sandakphu_photo.jpg" class="trek-img" alt="Sandakphu Trek">
            <h3>🌄 Sandakphu Trek – West Bengal</h3>
            <div class="price-tag">Starting from ₹8,750</div>
            <div class="card-footer">
                <button class="hotel-book-btn bookBtn">Book Now</button>
            </div>
        </div>
        ...
        <!-- CARD 6 -->
        <div class="trek-card">
            <img src="images/hardun_photo.jpg" class="trek-img" alt="Har Ki Dun">
            <h3>🧭 Har Ki Dun Adventure Trail</h3>
            <div class="price-tag">Starting from ₹10,999</div>
            <div class="card-footer">
                <button class="hotel-book-btn bookBtn">Book Now</button>
            </div>
        </div>
